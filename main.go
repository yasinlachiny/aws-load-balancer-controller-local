...
func main() {
	...
	networkingwebhook.NewIngressValidator(cloud.ELBV2(), ingGroupReconciler.GetModelBuilder(), ingGroupReconciler.GetGroupLoader(), mgr.GetClient(), controllerCFG.IngressConfig, ctrl.Log).SetupWithManager(mgr)
