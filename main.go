...
func main() {
	...
	networkingwebhook.NewIngressValidator(ingGroupReconciler.GetModelBuilder(), ingGroupReconciler.GetGroupLoader(), mgr.GetClient(), controllerCFG.IngressConfig, ctrl.Log).SetupWithManager(mgr)
